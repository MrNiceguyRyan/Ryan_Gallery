      ...
      <div className="relative rounded-t-[2.5rem] md:rounded-t-[5rem] bg-[#20241a] ring-1 ring-white/[0.05] overflow-hidden px-6 md:px-14 pt-16 md:pt-24 pb-6">
        ...
        <div className="colophon-reveal relative z-10 mt-14 md:mt-16 grid grid-cols-2 md:grid-cols-3 gap-y-10 items-center">
          <div className="text-center md:text-left md:pl-[8%]">
            <p className="font-ui text-[9px] tracking-[0.1em] uppercase text-white/58 mb-4">Pages</p>
          ...
          <div className="order-last md:order-none col-span-2 md:col-span-1 flex justify-center">
            <a
              href={`mailto:${EMAIL}`}
              className="group inline-flex items-center gap-2 px-7 py-3 rounded-full text-[12px] font-bold tracking-[0.1em] uppercase text-[#111112] transition-[scale] duration-300 hover:scale-[1.03] active:scale-[0.98]"
          ...
          <div className="text-center md:text-right md:pr-[8%]">
            <p className="font-ui text-[9px] tracking-[0.1em] uppercase text-white/58 mb-4">Follow on</p>
            <ul className="space-y-1.5 font-ui font-bold uppercase tracking-[0.08em] text-lg md:text-xl text-white/85">
        ...
        {/* Bottom bar */}
        <div className="colophon-reveal relative z-10 mt-14 pt-5 border-t border-white/10 flex flex-col md:flex-row gap-2 items-center justify-between font-ui text-[9px] tracking-[0.1em] uppercase text-white/58">
