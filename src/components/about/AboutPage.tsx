...
export default function AboutPage({ settings }: Props) {
  ...
  return (
    <div className="relative bg-[#181b10] text-[#FDFDFB] min-h-[100dvh]">
      ...
      <AnimatePresence>
        {!coverGone && (
          <motion.div
            ...
            className="fixed inset-0 z-[60] bg-[#181b10] text-[#FDFDFB] overflow-hidden"
          >
      ...
      <section className="px-6 md:px-16 py-12 md:py-16 border-t border-white/5">
        <div className="max-w-3xl mx-auto">
          ...
          <Reveal>
            ...
            <a
              href={`mailto:${email}`}
              className="group relative p-5 bg-[#22271a] hover:bg-white/[0.04] transition-colors duration-300 flex items-center gap-3.5"
            >
            ...
            <div className="p-5 bg-[#22271a] flex items-center gap-3.5">
